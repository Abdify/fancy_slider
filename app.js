...
const getImages = (query) => {
  fetch(`https://pixabay.com/api/?key=${KEY}=${query}&image_type=photo&pretty=true`)
    ...
    .then(data => {
      // console.log(data);
      // Additional feature 3: Number of images found:
      // document.getElementById('resultQuantity').innerText = `Showing ${data.hits.length} out of ${data.total} found images`;
...
const createSlider = () => {
  ...
  if (duration <= 0) {
    alert('Use your brain and give valid duration!');
    return;
  }
...
// Additional feature 1: Deselect button
